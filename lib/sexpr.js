...
import { sat, many, some, char, choice, token, optional, whitespace, Do } from './Parser.js'
...
const number = (function () {
    ...
    return choice(token(fraction1), token(fraction2), token(integer))
})()
